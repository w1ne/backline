...
Main UI inspected at 1440px and 390px; controls stay within their panels. Ethernet subsequently went DOWN; mDNS/ARP rediscovered the Pi on Wi-Fi at 172.16.22.3. Its controller was then verified in headless Chromium at 390px: connected, audio running, MIDI/microphone connected, selected Strings shown. The live API reported online=true, audioSuspended=false, AMT selected, no error.
